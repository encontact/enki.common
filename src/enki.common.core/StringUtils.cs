...
namespace enki.common.core
{
    ...
    {
        public const string EmailRegExp = @"(^([\w\+\=\-\.\&\u00C0-\u00ff]?)+[\u00C0-\u00ffa-zA-Z0-9_-]@[\u00C0-\u00ffa-zA-Z0-9]{1}(?:[\u00C0-\u00ffa-zA-Z0-9\-]*?|[\.]{1})[\u00C0-\u00ffa-zA-Z0-9]{1,}(?:\.{1}[\u00C0-\u00ffa-zA-Z0-9\-]{2,})+?$)|^([^<>]*?)<(\s*([\w\+\=\-\.\&\u00C0-\u00ff]?)+[\u00C0-\u00ffa-zA-Z0-9_-]@[\u00C0-\u00ffa-zA-Z0-9]{1}(?:[\u00C0-\u00ffa-zA-Z0-9\-]*?|[\.]{1})[\u00C0-\u00ffa-zA-Z0-9]{1,}(?:\.{1}[\u00C0-\u00ffa-zA-Z0-9]{2,})+?\s*)>$";
